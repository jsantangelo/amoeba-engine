...
public class SpriteExample extends GameActivity implements DrawListener, UpdateListener, InputListener
{
	...
	public SpriteExample()
	{
		...
		final float[] positionData = {
				// X, Y, Z
				-0.5f, 0.50f, 0.0f, -0.5f, -0.5f, 0.0f, 0.50f, 0.50f, 0.0f, 0.50f, -0.5f, 0.0f, };
	...
	public void onDraw(final Camera camera)
	{
		...
		Matrix.translateM(modelMatrix, 0, 250, 250, 0);
